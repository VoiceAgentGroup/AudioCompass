...
# from .ai_judge import OPENAI_Judge
# from loguru import logger

# def evaluate_chat(input_file, model_name, split):
#     """
#     对 chat 模式下的生成结果打分并聚合。
#     Args:
...
#     Returns:
#       summary (dict): {
#         'overall': {'avg_score': float, 'count': int},
#         'by_task': {
#             task_name: {'avg_score': float, 'count': int},
#             ...
#         }
#       }
#     """
...
#     summary = {
#         'overall': {'avg_score': overall_avg, 'count': total_count},
#         'by_task': {}
#     }
#     for task, stats in task_stats.items():
#         cnt = stats['count']
#         summary['by_task'][task] = {
#             'avg_score': stats['score'] / cnt if cnt else 0.0,
#             'count': cnt
#         }
#     return summary
